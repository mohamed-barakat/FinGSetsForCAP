  ...
  function ( CAP_NAMED_ARGUMENTS )
    ...
    Bisets :=
      CreateCapCategoryWithDataTypes( name,
              ...
              CapJitDataTypeOfNTupleOf( 2,
                      rec( category := false, filter := IsObjectInSkeletalCategoryOfFinGSets ),
                      CapJitDataTypeOfListOf( rec( category := false, filter := IsMorphismInSkeletalCategoryOfFinGSets ) ) ),
              fail :
    ...
    AddIsWellDefinedForMorphisms( Bisets,
      function ( Bisets, phi )
        ...
        HSet := UnderlyingSkeletalCategoryOfFinGSets( Target( phi ) );
    ...
    AddIsEqualForMorphisms( Bisets,
      function ( Bisets, mor1, mor2 )
        ...
        HSet := UnderlyingSkeletalCategoryOfFinGSets( Target( mor1 ) );
    ...
    AddIdentityMorphism( Bisets,
      function ( Bisets, group_in_biset_category )
        ...
        GSet := UnderlyingSkeletalCategoryOfFinGSets( group_in_biset_category );
    ...
    AddPreCompose( Bisets,
      function ( Bisets, mor_pre, mor_post )
        ...
        GSet := UnderlyingSkeletalCategoryOfFinGSets( Source( mor_pre ) );
        HSet := UnderlyingSkeletalCategoryOfFinGSets( Source( mor_post ) );
        KSet := UnderlyingSkeletalCategoryOfFinGSets( Target( mor_post ) );
        ...
        pair := ExtendFunctorToSkeletalCategoryOfFinGSetsData( HSet, Pair( obj_func, mor_func ), KSet )[2];
