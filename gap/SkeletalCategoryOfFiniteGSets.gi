...
##
InstallMethod( SkeletalCategoryOfFiniteGSets,
        "for a group",
        [ IsGroup ],
 ...
 FunctionWithNamedArguments(
  ...
  function ( CAP_NAMED_ARGUMENTS, group )
    ...
    TG := SkeletalCategoryOfTransitiveGSets( group : FinalizeCategory := true );
    ...
    SkeletalFinGSets :=
      ReinterpretationOfCategory( sFinGSets,
              rec( name := Concatenation( "SkeletalCategoryOfFiniteGSets( ", name, " )" ),
                   category_filter := IsSkeletalCategoryOfFiniteGSets,
                   category_object_filter := IsObjectInSkeletalCategoryOfFiniteGSets,
                   category_morphism_filter := IsMorphismInSkeletalCategoryOfFiniteGSets,
    ...
    FindConnectedcomponentsForCoequalizer :=
      function ( SkeletalFinGSets, source, list_of_parallel_morphisms, target )
        local G, l, m_source, m_target, data, maps, mors, n, source_visited, target_visited, H, components,
    ...
    AddProjectionOntoCoequalizer( SkeletalFinGSets,
      function ( cat, target, list_of_parallel_morphisms )
        local source, n, data, maps, mors, G, l, U, CH, components, H, m_target, componentpos, equations, welldefinednesspi,
...
##
InstallMethodForCompilerForCAP( ExtendFunctorToSkeletalCategoryOfFiniteGSetsData,
...
##
InstallMethod( ExtendFunctorToSkeletalCategoryOfFiniteGSets,
        "for a functor",
        [ IsCapFunctor ],
  ...
  function( F )
    ...
    SkeletalFinGSets := SkeletalCategoryOfFiniteGSets( UnderlyingGroup( C ) );
    
    data := ExtendFunctorToSkeletalCategoryOfFiniteGSetsData(
                    SkeletalFinGSets,
...
InstallMethod( \.,
        ...
        [ IsSkeletalCategoryOfFiniteGSets, IsPosInt ],
  ...
  function( SkeletalFinGSets, string_as_int )
    ...
    Y := ReinterpretationFunctor( SkeletalFinGSets );
