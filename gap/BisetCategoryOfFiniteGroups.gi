  ...
  function ( CAP_NAMED_ARGUMENTS )
    ...
    Bisets :=
      CreateCapCategoryWithDataTypes( name,
              ...
              CapJitDataTypeOfNTupleOf( 2,
                      rec( category := false, filter := IsObjectInSkeletalCategoryOfFiniteGSets ),
                      CapJitDataTypeOfListOf( rec( category := false, filter := IsMorphismInSkeletalCategoryOfFiniteGSets ) ) ),
              fail :
    ...
    AddIsWellDefinedForMorphisms( Bisets,
      function ( Bisets, phi )
        ...
        HSet := UnderlyingSkeletalCategoryOfFiniteGSets( Target( phi ) );
    ...
    AddIsEqualForMorphisms( Bisets,
      function ( Bisets, mor1, mor2 )
        ...
        HSet := UnderlyingSkeletalCategoryOfFiniteGSets( Target( mor1 ) );
    ...
    AddIdentityMorphism( Bisets,
      function ( Bisets, group_in_biset_category )
        ...
        GSet := UnderlyingSkeletalCategoryOfFiniteGSets( group_in_biset_category );
    ...
    AddPreCompose( Bisets,
      function ( Bisets, mor_pre, mor_post )
        ...
        GSet := UnderlyingSkeletalCategoryOfFiniteGSets( Source( mor_pre ) );
        HSet := UnderlyingSkeletalCategoryOfFiniteGSets( Source( mor_post ) );
        KSet := UnderlyingSkeletalCategoryOfFiniteGSets( Target( mor_post ) );
        ...
        pair := ExtendFunctorToSkeletalCategoryOfFiniteGSetsData( HSet, Pair( obj_func, mor_func ), KSet )[2];
