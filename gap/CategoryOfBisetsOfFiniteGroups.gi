...
##
InstallMethod( CategoryOfBisetsOfFiniteGroupsUsingFunctors,
        [  ],
 ...
 FunctionWithNamedArguments(
  ...
  function ( CAP_NAMED_ARGUMENTS )
    ...
    name := "CategoryOfBisetsOfFiniteGroupsUsingFunctors( )";
...
BindGlobal( "CategoryOfBisetsOfFiniteGroups", CategoryOfBisetsOfFiniteGroupsUsingFunctors( ) );
