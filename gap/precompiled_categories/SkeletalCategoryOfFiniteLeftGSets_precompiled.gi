...
function ( cat_1, alpha_1, beta_1 )
    local deduped_1_1, deduped_2_1, hoisted_3_1, deduped_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, hoisted_9_1, deduped_10_1, deduped_11_1, deduped_12_1, deduped_13_1;
    deduped_13_1 := TripleOfLists( beta_1 );
    deduped_12_1 := TripleOfLists( alpha_1 );
    deduped_11_1 := Source( alpha_1 );
    deduped_10_1 := [ 1 .. NumberOfTransitiveGSets( cat_1 ) ];
    hoisted_8_1 := deduped_13_1[3];
    hoisted_7_1 := PairOfSumAndListOfMultiplicities( Source( beta_1 ) )[2];
    hoisted_9_1 := List( deduped_10_1, function ( o_2 )
            local hoisted_1_2;
            hoisted_1_2 := hoisted_8_1[o_2];
            return List( [ 1 .. hoisted_7_1[o_2] ], function ( i_3 )
                    return hoisted_1_2[i_3];
                end );
        end );
    hoisted_6_1 := deduped_12_1[3];
    hoisted_5_1 := deduped_13_1[2];
    deduped_4_1 := deduped_12_1[2];
    hoisted_3_1 := deduped_13_1[1];
    deduped_2_1 := deduped_12_1[1];
    deduped_1_1 := PairOfSumAndListOfMultiplicities( deduped_11_1 )[2];
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_11_1, Range( beta_1 ), TripleOfLists, NTuple( 3, List( deduped_10_1, function ( c_2 )
                local hoisted_1_2, hoisted_2_2;
                hoisted_2_2 := deduped_4_1[c_2];
                hoisted_1_2 := deduped_2_1[c_2];
                return List( [ 1 .. deduped_1_1[c_2] ], function ( i_3 )
                        return hoisted_3_1[1 + hoisted_1_2[i_3]][1 + hoisted_2_2[i_3]];
                    end );
            end ), List( deduped_10_1, function ( c_2 )
                local hoisted_1_2, hoisted_2_2;
                hoisted_2_2 := deduped_4_1[c_2];
                hoisted_1_2 := deduped_2_1[c_2];
                return List( [ 1 .. deduped_1_1[c_2] ], function ( i_3 )
                        return hoisted_5_1[1 + hoisted_1_2[i_3]][1 + hoisted_2_2[i_3]];
                    end );
                ...
                hoisted_3_2 := deduped_4_1[deduped_5_2];
                hoisted_2_2 := deduped_2_1[deduped_5_2];
                hoisted_1_2 := hoisted_6_1[deduped_5_2];
                hoisted_4_2 := CAP_JIT_INCOMPLETE_LOGIC( List( [ 1 .. deduped_1_1[deduped_5_2] ], function ( i_3 )
                          return MultiplyGroupElements( CAP_JIT_INCOMPLETE_LOGIC( hoisted_1_2[CAP_JIT_INCOMPLETE_LOGIC( i_3 )] ), hoisted_9_1[1 + hoisted_2_2[i_3]][1 + hoisted_3_2[i_3]] );
                      end ) );
...
########
function ( cat_1, alpha_1, beta_1 )
    local deduped_1_1, deduped_2_1, hoisted_3_1, deduped_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, hoisted_9_1, hoisted_10_1, hoisted_11_1, deduped_12_1, deduped_13_1, deduped_14_1, deduped_15_1;
    deduped_15_1 := TripleOfLists( beta_1 );
    deduped_14_1 := TripleOfLists( alpha_1 );
    deduped_13_1 := Source( alpha_1 );
    deduped_12_1 := [ 1 .. NumberOfTransitiveGSets( cat_1 ) ];
    hoisted_9_1 := deduped_15_1[3];
    hoisted_8_1 := PairOfSumAndListOfMultiplicities( Source( beta_1 ) )[2];
    hoisted_10_1 := List( deduped_12_1, function ( o_2 )
            local hoisted_1_2;
            hoisted_1_2 := hoisted_9_1[o_2];
            return List( [ 1 .. hoisted_8_1[o_2] ], function ( i_3 )
                    return hoisted_1_2[i_3];
                end );
        end );
    hoisted_6_1 := deduped_14_1[3];
    deduped_1_1 := PairOfSumAndListOfMultiplicities( deduped_13_1 )[2];
    hoisted_7_1 := List( deduped_12_1, function ( o_2 )
            local hoisted_1_2;
    ...
    deduped_4_1 := deduped_14_1[2];
    deduped_2_1 := deduped_14_1[1];
    hoisted_11_1 := List( deduped_12_1, function ( c_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2;
            hoisted_3_2 := deduped_4_1[c_2];
            hoisted_2_2 := deduped_2_1[c_2];
            hoisted_1_2 := hoisted_7_1[c_2];
            return List( [ 1 .. deduped_1_1[c_2] ], function ( i_3 )
                    return MultiplyGroupElements( hoisted_1_2[i_3], hoisted_10_1[1 + hoisted_2_2[i_3]][1 + hoisted_3_2[i_3]] );
                end );
        end );
    hoisted_5_1 := deduped_15_1[2];
    hoisted_3_1 := deduped_15_1[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_13_1, Range( beta_1 ), TripleOfLists, NTuple( 3, List( deduped_12_1, function ( c_2 )
                local hoisted_1_2, hoisted_2_2;
                hoisted_2_2 := deduped_4_1[c_2];
                hoisted_1_2 := deduped_2_1[c_2];
                return List( [ 1 .. deduped_1_1[c_2] ], function ( i_3 )
            ...
            end ), List( deduped_12_1, function ( c_2 )
                local hoisted_1_2, hoisted_2_2;
                hoisted_2_2 := deduped_4_1[c_2];
                hoisted_1_2 := deduped_2_1[c_2];
                return List( [ 1 .. deduped_1_1[c_2] ], function ( i_3 )
            ...
            end ), List( deduped_12_1, function ( o_2 )
                local hoisted_1_2;
                hoisted_1_2 := hoisted_11_1[o_2];
                return List( [ 1 .. deduped_1_1[o_2] ], function ( i_3 )
                        return hoisted_1_2[i_3];
                    end );
            end ) ) );
...
function ( cat_1, Y_1, automorphisms_1 )
    ...
    deduped_14_1 := List( deduped_26_1, function ( c_2 )
            ...
            return List( automorphisms_1, function ( x_3 )
                    local hoisted_1_3;
                    hoisted_1_3 := TripleOfLists( x_3 )[3][deduped_1_2];
    ...
    deduped_1_1 := List( deduped_26_1, function ( c_2 )
            return List( automorphisms_1, function ( x_3 )
                    return CAP_JIT_INCOMPLETE_LOGIC( PermList( List( CAP_JIT_INCOMPLETE_LOGIC( TripleOfLists( x_3 )[2][c_2] ), function ( i_4 )
                                return 1 + i_4;
                            end ) ) );
                end );
        end );
    ...
    deduped_18_1 := List( deduped_26_1, function ( c_2 )
            ...
            return List( [ 1 .. deduped_3_1[c_2] ], function ( o_3 )
                    ...
                    return List( [ 1 .. deduped_4_3 * deduped_7_1 - (deduped_4_3 - 1) ], function ( j_4 )
                            local deduped_1_4;
                            deduped_1_4 := hoisted_1_3[j_4];
                            return MultiplyGroupElements( MultiplyGroupElements( hoisted_2_3[deduped_1_4[1]], hoisted_8_2[deduped_1_4[3]][deduped_1_4[2]] ), hoisted_3_3[deduped_1_4[4]] );
                        end );
                end );
        end );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, Y_1, CreateCapCategoryObjectWithAttributes( cat_1, PairOfSumAndListOfMultiplicities, NTuple( 2, Sum( deduped_25_1 ), deduped_25_1 ) ), TripleOfLists, NTuple( 3, List( deduped_26_1, function ( c_2 )
                local hoisted_1_2, hoisted_2_2;
                hoisted_2_2 := deduped_24_1[c_2];
                hoisted_1_2 := deduped_6_1[c_2];
                return Concatenation( List( [ 1 .. deduped_3_1[c_2] ], function ( o_3 )
                            return ListWithIdenticalEntries( hoisted_1_2[o_3], -1 + hoisted_2_2[o_3] );
                        end ) ){deduped_23_1[c_2]};
            end ), List( deduped_26_1, function ( c_2 )
                local hoisted_1_2, hoisted_2_2, hoisted_3_2;
                hoisted_3_2 := deduped_24_1[c_2];
                hoisted_2_2 := CAP_JIT_INCOMPLETE_LOGIC( Sum( deduped_3_1{[ 1 .. CAP_JIT_INCOMPLETE_LOGIC( c_2 ) - 1 ]} ) );
                hoisted_1_2 := deduped_6_1[c_2];
                return Concatenation( List( [ 1 .. deduped_3_1[c_2] ], function ( o_3 )
                            local hoisted_1_3;
                            hoisted_1_3 := hoisted_3_2[o_3];
                            return ListWithIdenticalEntries( hoisted_1_2[o_3], Number( deduped_21_1{[ 1 .. hoisted_2_2 + o_3 - 1 ]}, function ( i_4 )
...
function ( cat_1, Y_1, automorphisms_1 )
    ...
    deduped_17_1 := List( deduped_37_1, function ( c_2 )
            return List( automorphisms_1, function ( x_3 )
                    ...
                    return List( deduped_37_1, function ( o_4 )
                              local hoisted_1_4;
    ...
    deduped_16_1 := List( deduped_37_1, function ( c_2 )
            return List( automorphisms_1, function ( x_3 )
                    ...
                    return List( deduped_37_1, function ( o_4 )
                              ...
                              hoisted_2_4 := hoisted_5_3[o_4];
                              hoisted_1_4 := hoisted_3_3[o_4];
                              return List( [ 1 .. hoisted_1_3[o_4] ], function ( i_5 )
    ...
    deduped_2_1 := PairOfSumAndListOfMultiplicities( Y_1 )[2];
    deduped_1_1 := List( deduped_37_1, function ( c_2 )
            return List( automorphisms_1, function ( x_3 )
                    return List( TripleOfLists( x_3 )[2], function ( logic_new_func_list_4 )
                              return PermList( List( logic_new_func_list_4, function ( i_5 )
                                        return 1 + i_5;
                                    end ) );
                          end )[c_2];
                end );
    ...
    hoisted_7_1 := List( deduped_37_1, function ( c_2 )
            return List( OrbitsPerms( deduped_1_1[c_2], [ 1 .. deduped_2_1[c_2] ] ), Length );
        end );
    hoisted_3_1 := List( deduped_37_1, function ( c_2 )
            return Length( OrbitsPerms( deduped_1_1[c_2], [ 1 .. deduped_2_1[c_2] ] ) );
        end );
    deduped_4_1 := List( deduped_37_1, function ( c_2 )
            return hoisted_3_1[c_2];
        end );
    deduped_8_1 := List( deduped_37_1, function ( c_2 )
            local hoisted_1_2;
            hoisted_1_2 := hoisted_7_1[c_2];
    ...
    deduped_22_1 := List( deduped_37_1, function ( c_2 )
            local hoisted_1_2, hoisted_2_2;
    ...
    deduped_23_1 := List( deduped_37_1, function ( c_2 )
            ...
            return List( [ 1 .. deduped_4_1[c_2] ], function ( o_3 )
                    ...
                    return List( [ 1 .. deduped_4_3 * deduped_9_1 - (deduped_4_3 - 1) ], function ( j_4 )
                            local deduped_1_4;
                            deduped_1_4 := hoisted_1_3[j_4];
                            return MultiplyGroupElements( MultiplyGroupElements( hoisted_2_3[deduped_1_4[1]], hoisted_4_2[deduped_1_4[3]][deduped_1_4[2]] ), hoisted_3_3[deduped_1_4[4]] );
                        end );
                end );
        end );
    deduped_10_1 := List( deduped_37_1, function ( c_2 )
            local hoisted_1_2;
            hoisted_1_2 := deduped_8_1[c_2];
            return List( [ 1 .. deduped_4_1[c_2] ], function ( o_3 )
                    local deduped_1_3;
    ...
    deduped_6_1 := List( deduped_38_1, GeneratorsOfMagmaWithInverses );
    deduped_5_1 := CardinalitiesOfTransitiveGSets( cat_1 );
    hoisted_26_1 := List( deduped_37_1, function ( c_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2;
            ...
            return List( [ 1 .. deduped_4_1[c_2] ], function ( o_3 )
                    local hoisted_1_3, hoisted_2_3, deduped_4_3;
                    hoisted_1_3 := hoisted_2_2[o_3];
                    deduped_4_3 := SubmagmaWithInverses( deduped_39_1, Concatenation( hoisted_3_2, List( [ 1 .. hoisted_1_2[o_3] ], function ( i_4 )
                                return hoisted_1_3[i_4];
                            end ) ) );
                    hoisted_2_3 := Index( deduped_39_1, deduped_4_3 );
                    return SafeFirst( Filtered( deduped_37_1, function ( i_4 )
                              return deduped_5_1[i_4] = hoisted_2_3;
                          end ), function ( c_4 )
                            return IsConjugate( deduped_39_1, deduped_4_3, deduped_38_1[c_4] );
                        end );
                end );
        end );
    deduped_35_1 := List( deduped_37_1, function ( c_2 )
            local hoisted_1_2;
            hoisted_1_2 := hoisted_26_1[c_2];
            return List( [ 1 .. deduped_4_1[c_2] ], function ( o_3 )
                    local hoisted_1_3;
                    hoisted_1_3 := hoisted_1_2[o_3];
                    return SafePositionProperty( deduped_37_1, function ( d_4 )
                            return hoisted_1_3 = d_4;
                        end );
                end );
        end );
    deduped_27_1 := Concatenation( deduped_35_1 );
    deduped_36_1 := List( deduped_37_1, function ( c_2 )
            return Number( deduped_27_1, function ( i_3 )
                    return i_3 = c_2;
                end );
        end );
    hoisted_32_1 := List( deduped_37_1, function ( c_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2;
            hoisted_3_2 := deduped_6_1[c_2];
            hoisted_2_2 := deduped_23_1[c_2];
            hoisted_1_2 := deduped_10_1[c_2];
            return List( [ 1 .. deduped_4_1[c_2] ], function ( o_3 )
                    ...
                    hoisted_2_3 := Index( deduped_39_1, deduped_4_3 );
                    return RepresentativeAction( deduped_39_1, deduped_4_3, deduped_38_1[SafeFirst( Filtered( deduped_37_1, function ( i_4 )
                                 return deduped_5_1[i_4] = hoisted_2_3;
                             end ), function ( c_4 )
                               return IsConjugate( deduped_39_1, deduped_4_3, deduped_38_1[c_4] );
                           end )] );
    ...
    hoisted_33_1 := List( deduped_37_1, function ( c_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2;
            hoisted_3_2 := hoisted_32_1[c_2];
    ...
    deduped_30_1 := List( deduped_37_1, function ( c_2 )
            local hoisted_1_2;
    ...
    hoisted_34_1 := List( deduped_37_1, function ( c_2 )
            return hoisted_33_1[c_2]{deduped_30_1[c_2]};
        end );
    hoisted_31_1 := List( deduped_37_1, function ( c_2 )
            return Sum( deduped_4_1{[ 1 .. c_2 - 1 ]} );
        end );
    return CreateCapCategoryMorphismWithAttributes( cat_1, Y_1, CreateCapCategoryObjectWithAttributes( cat_1, PairOfSumAndListOfMultiplicities, NTuple( 2, Sum( deduped_36_1 ), deduped_36_1 ) ), TripleOfLists, NTuple( 3, List( deduped_37_1, function ( c_2 )
                local hoisted_1_2, hoisted_2_2;
            ...
            end ), List( deduped_37_1, function ( c_2 )
                local hoisted_1_2, hoisted_2_2, hoisted_3_2;
                hoisted_3_2 := deduped_35_1[c_2];
                hoisted_2_2 := hoisted_31_1[c_2];
                hoisted_1_2 := deduped_8_1[c_2];
                return Concatenation( List( [ 1 .. deduped_4_1[c_2] ], function ( o_3 )
                            local hoisted_1_3;
                            hoisted_1_3 := hoisted_3_2[o_3];
            ...
            end ), List( deduped_37_1, function ( o_2 )
                local hoisted_1_2;
