...
CapJitAddTypeSignature( "CardinalitiesOfObjects", [ IsSkeletalCategoryOfTransitiveGSets ],
...
CapJitAddTypeSignature( "IndexOfObject", [ IsObjectInSkeletalCategoryOfTransitiveGSets ], IsBigInt );
...
CapJitAddTypeSignature( "UnderlyingGroupElement", [ IsMorphismInSkeletalCategoryOfTransitiveGSets ],
 function ( input_types )
